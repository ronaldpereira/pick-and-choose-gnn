...
@pytest.mark.parametrize(
    ...
    argvalues=[
        (np.array([[0, 1, 1], [1, 0, 1], [0, 1, 1]]), np.array([0, 1, 0]), 0, 0.25),
        (np.array([[0, 1, 1], [1, 0, 1], [0, 1, 1]]), np.array([0, 1, 0]), 1, 0.7071),
        (np.array([[0, 1, 1], [1, 0, 1], [0, 1, 1]]), np.array([0, 1, 0]), 2, 0.433),
        (np.array([[0, 1, 0], [1, 0, 1], [0, 1, 0]]), np.array([0, 0, 1]), 0, 0.3536),
        (np.array([[0, 1, 0], [1, 0, 1], [0, 1, 0]]), np.array([0, 0, 1]), 1, 0.5),
        (np.array([[0, 1, 0], [1, 0, 1], [0, 1, 0]]), np.array([0, 0, 1]), 2, 0.7071),
    ]
)
